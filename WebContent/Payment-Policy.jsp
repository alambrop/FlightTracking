     ...
     <thead>
      ...
      <tbody>
        ...
        <tr id="break"><td height="30"> </td></tr>
         <tr id="total">
          <td>Total</td>
          <td class="price">$<%=request.getAttribute("total")%></td>
        </tr>
      </tbody>
   </table>
    <br>
      ...
      <br>
		<form id='AddPolicy' action="AddPolicy" method="post">
		 <input type="hidden" name="policyPrice" value= <%=request.getAttribute("policyPrice")%> > 
